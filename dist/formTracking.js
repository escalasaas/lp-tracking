...
export function analyticsFormId(section) {
 ...
 */
export function resolveFrictionField(touched, filled, lastFieldInteracted) {
 ...
 */
export function fieldIdFromElement(el) {
 ...
 */
export function classifyFormError(form) {
 ...
 */
export function classifyAllFormErrors(form) {
...
export function controlHasValue(el) {
